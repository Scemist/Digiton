<nav class="flex justify-between">
	<div class="mx-auto flex justify-between items-center flex-1 py-2" style="max-width: 1200px">
		...
		<button class="rounded-full text-primary-700 mr-5 bg-primary-100 py-5 h-8 px-6 flex items-center font-semibold hover:bg-primary-400 hover:text-primary-950 transition" href="{#">
			Contato
		</button>
		{{-- <button class="rounded text-primary-700 bg-primary-100 py-1 h-8 px-2 flex items-center font-semibold hover:bg-primary-400 hover:text-primary-950 transition" href="{#" id="myBtn">
