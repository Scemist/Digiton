...
@section('main')
	...
	<section class="mt-16 md:mt-28 w-full">
		...
		<div class="flex flex-col gap-10 items-center">
			<div class="flex flex-col justify-center items-center gap-y-9 mt-2 bg-gradient-to-br from-primary-50 to-primary-100 text-primary-800 opacity-80 rounded-3xl py-8 px-4 md:px-10">
				<div class="flex flex-col items-center p-1">
					<h4>WhatsApp</h4>
					
					<a class="flex gap-2 p-1 items-center mt-2 lg:text-xl text-primary-500 hover:text-secondary-700 transition font-semibold" href="tel:(17) 98816-0142">
				...
				<div class="flex flex-col items-center p-1">
					<h4>E-mail</h4>
					<a class="flex gap-2 p-1 items-center mt-2 lg:text-xl text-primary-500 hover:text-secondary-700 transition font-semibold" href="mailto:contato.digiton.tech@gmail.com">
